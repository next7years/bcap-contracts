 ...
 * @notice Contract in charge or reading the information from a Chainlink Oracle. 
 * TCAP contracts read the price directly from this contract. More information can be found on Chainlink Documentation
 */
contract ChainlinkOracle is Ownable, IERC165 {
   ...
   * used https://data.chain.link/mcap-usd to get the total market cap index number from chain link
   */
