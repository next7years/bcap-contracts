...
// Governor contract for DAO, constructed by timelock interface, and CAPX governance tokens
pragma solidity 0.8.3;

pragma experimental ABIEncoderV2;
import "../interface/CapxInterface.sol";
import "../interface/TimelockInterface.sol";

contract GovernorAlpha {
  /// @notice The name of this contract
  string public constant name = "Cap X Fund Governor 1.0";
  ...
  /// @notice The address of the CAPX Protocol Timelock
  TimelockInterface public timelock;

  /// @notice The address of the CAPX governance token
  CapxInterface public capx;
  ...
  constructor(address timelock_, address capx_) {
    timelock = TimelockInterface(timelock_);
    capx = CapxInterface(capx_);
  }
  ...
  function propose(
    ...
    require(
      capx.getPriorVotes(msg.sender, sub256(block.number, 1)) >
        proposalThreshold(),
  ...
  function cancel(uint256 proposalId) public {
    ...
    Proposal storage proposal = proposals[proposalId];
    require(
      capx.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
        proposalThreshold(),
  ...
  function _castVote(
    ...
    uint96 votes = capx.getPriorVotes(voter, proposal.startBlock);
